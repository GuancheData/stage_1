        ...
        for num_books in BOOK_SET_SIZES:
            ...
            try:
                def run_mongo():
                    ...
                    gc.collect()
                    indexer = MongoDB(databaseName=db_name, collectionName="benchmark",
                ...
                cleanup_mongodb(db_name)
                gc.collect()
                indexer_mongo = MongoDB(databaseName=db_name, collectionName="benchmark",
                                        downloadedBooksPath=DATALAKE_PATH)
                try:
                    indexer_mongo.buildIndexForBooks(synthetic_set, language_refs)
