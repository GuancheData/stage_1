...
from indexer.invertedindex.MonoliticStructure.MonoliticIndexer import MonoliticIndexer


class StopWords:
    def __init__(self, booksMetadataContentPath, outputPath):
        self.booksMetadataContentPath = booksMetadataContentPath
        self.DataStructure = MonoliticIndexer(outputPath)
            ...
            with open(f, 'r', encoding='utf-8') as file:
                ...
                for line in file:
                    ...
                    for token in tokens:
                        ...
                        wordPosition += 1
                self.DataStructure.insertInformation(fileMatch, positionDict)
        self.DataStructure._save()
